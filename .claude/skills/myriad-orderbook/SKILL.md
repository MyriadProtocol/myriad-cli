...
user-invocable: true
allowed-tools: Bash(myriad ob *), Bash(myriad wallet balances *)
---
...
- Use [references/recipes.md](../../skills/myriad-orderbook/references/recipes.md) for discovery, render, order, cancel, and position recipes.
